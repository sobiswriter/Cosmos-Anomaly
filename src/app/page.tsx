...
const prebuiltEvents: PrebuiltEvent[] = [
  {
    id: 'titanic',
    ...
    aiHint: 'titanic ship',
    initialChoice: "The RMS Titanic, maiden voyage, April 1912. The ship feels invincible, but a sense of unease hangs in the frigid air.",
  ...
  },
  {
    ...
    initialChoice: "Soviet Space Program, 1968. The N1 moon rocket has failed its previous tests, and pressure from the Kremlin is immense.",
  ...
  },
  {
    ...
    initialChoice: "A global summit in 1950, after a devastating war. World leaders are debating a global government based on total security and surveillance to prevent future conflict.",
  ...
  },
  {
    ...
    initialChoice: "Woolsthorpe Manor, 1666. A young Isaac Newton is sitting under an apple tree, deep in thought, pondering the nature of the cosmos. An apple dangles from a branch just above his head.",
  ...
  },
  {
    ...
    initialChoice: "The Library of Alexandria in 48 BC. The city is in turmoil as Julius Caesar's forces battle the Egyptian army. Smoke is on the horizon, and the scent of fear mixes with the smell of old papyrus.",
  ...
  },
  {
    ...
    initialChoice: "New Delhi, 1947. A high-ranking British official is meeting with Indian independence leaders. The air is thick with tension and the desire for freedom, but imperial pride and economic interests are powerful forces resisting change.",
...
export default function MainMenu() {
  ...
  const handleStartSimulation = (event: PrebuiltEvent) => {
